...
class Case(BaseModel):
    ...
    parent_category_code = db.Column(db.String(16), nullable=False, server_default=db.text("''"))
    parent_category_name = db.Column(db.String(64), nullable=False, server_default=db.text("''"))
    category_code = db.Column(db.String(16), nullable=False, server_default=db.text("''"))
